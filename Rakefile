...
desc 'Generate documentation for the facebook_connect extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'FacebookConnectExtension'
...
desc 'Test the facebook_connect extension.'
...
namespace :test do
  desc 'Functional test the facebook_connect extension.'
  ...
  desc 'Unit test the facebook_connect extension.'
